...
`),r=[];for(let e=0,i=n.length;e<i;e++){let i=n[e].trimStart();if(i.length===0)continue;let a=i.charAt(0);if(a!==`#`)if(a===`v`){let e=i.split(Wg);switch(e[0]){case`v`:t.vertices.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])),e.length>=7?(Xg.setRGB(parseFloat(e[4]),parseFloat(e[5]),parseFloat(e[6]),ws),t.colors.push(Xg.r,Xg.g,Xg.b)):t.colors.push(void 0,void 0,void 0);break;case`vn`:t.normals.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));break;case`vt`:t.uvs.push(parseFloat(e[1]),parseFloat(e[2]));break}}else if(a===`f`){let e=i.slice(1).trim().split(Wg),n=[];for(let t=0,r=e.length;t<r;t++){let r=e[t];if(r.length>0){let e=r.split(`/`);n.push(e)}}let r=n[0];for(let e=1,i=n.length-1;e<i;e++){let i=n[e],a=n[e+1];t.addFace(r[0],i[0],a[0],r[1],i[1],a[1],r[2],i[2],a[2])}}else if(a===`l`){let e=i.substring(1).trim().split(` `),n=[],r=[];if(i.indexOf(`/`)===-1)n=e;else for(let t=0,i=e.length;t<i;t++){let i=e[t].split(`/`);i[0]!==``&&n.push(i[0]),i[1]!==``&&r.push(i[1])}t.addLineGeometry(n,r)}else if(a===`p`){let e=i.slice(1).trim().split(` `);t.addPointGeometry(e)}else if((r=Bg.exec(i))!==null){let e=(` `+r[0].slice(1).trim()).slice(1);t.startObject(e)}else if(Hg.test(i))t.object.startMaterial(i.substring(7).trim(),t.materialLibraries);else if(Vg.test(i))t.materialLibraries.push(i.substring(7).trim());else if(Ug.test(i))console.warn(`THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.`);else if(a===`s`){if(r=i.split(` `),r.length>1){let e=r[1].trim().toLowerCase();t.object.smooth=e!==`0`&&e!==`off`}else t.object.smooth=!0;let e=t.object.currentMaterial();e&&(e.smooth=t.object.smooth)}else{if(i===`\0`)continue;console.warn(`THREE.OBJLoader: Unexpected line: "`+i+`"`)}}t.finalize();let i=new dl;if(i.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0))for(let e=0,n=t.objects.length;e<n;e++){let n=t.objects[e],r=n.geometry,a=n.materials,o=r.type===`Line`,s=r.type===`Points`,c=!1;if(r.vertices.length===0)continue;let l=new fu;l.setAttribute(`position`,new eu(r.vertices,3)),r.normals.length>0&&l.setAttribute(`normal`,new eu(r.normals,3)),r.colors.length>0&&(c=!0,l.setAttribute(`color`,new eu(r.colors,3))),r.hasUVIndices===!0&&l.setAttribute(`uv`,new eu(r.uvs,2));let u=[];for(let e=0,n=a.length;e<n;e++){let n=a[e],r=n.name+`_`+n.smooth+`_`+c,i=t.materials[r];if(this.materials!==null){if(i=this.materials.create(n.name),o&&i&&!(i instanceof Xu)){let e=new Xu;_u.prototype.copy.call(e,i),e.color.copy(i.color),i=e}else if(s&&i&&!(i instanceof ld)){let e=new ld({size:10,sizeAttenuation:!1});_u.prototype.copy.call(e,i),e.color.copy(i.color),e.map=i.map,i=e}}i===void 0&&(i=o?new Xu:s?new ld({size:1,sizeAttenuation:!1}):new Pd,i.name=n.name,i.flatShading=!n.smooth,i.vertexColors=c,t.materials[r]=i),u.push(i)}let d;if(u.length>1){for(let e=0,t=a.length;e<t;e++){let t=a[e];l.addGroup(t.groupStart,t.groupCount,e)}d=o?new cd(l,u):s?new md(l,u):new Ru(l,u)}else d=o?new cd(l,u[0]):s?new md(l,u[0]):new Ru(l,u[0]);d.name=n.name,i.add(d)}else if(t.vertices.length>0){let e=new ld({size:1,sizeAttenuation:!1}),n=new fu;n.setAttribute(`position`,new eu(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(n.setAttribute(`color`,new eu(t.colors,3)),e.vertexColors=!0);let r=new md(n,e);i.add(r)}return i}},$g=class e extends Ru{constructor(){super(e.Geometry,new Eu({opacity:0,transparent:!0})),this.isLensflare=!0,this.type=`Lensflare`,this.frustumCulled=!1,this.renderOrder=1/0;let t=new K,n=new K,r=new gd(16,16),i=new gd(16,16),a=H,o=e.Geometry,s=new Md({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
		...
		}`};function f_({opacity:e=.2}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=new yl,r=new bf(75,window.innerWidth/window.innerHeight,.1,1e3);r.position.set(0,7,10);let i=new ug({precision:`highp`,alpha:!0,antialias:!0});i.setSize(window.innerWidth,window.innerHeight),i.setPixelRatio(window.devicePixelRatio),i.setClearColor(0,0),e.appendChild(i.domElement);let a=new xg(r,i.domElement);a.autoRotate=!0,a.autoRotateSpeed=1,a.enableDamping=!0,a.enableRotate=!0,a.enablePan=!1,a.enableZoom=!1;let o=new a_(i);o.addPass(new c_(n,r));let s=new n_(d_),c=i.getPixelRatio();s.material.uniforms.resolution.value.set(1/(window.innerWidth*c*1.25),1/(window.innerHeight*c*1.25)),o.addPass(s),o.addPass(new u_(new G(window.innerWidth,window.innerHeight),.5,.1,0)),o.addPass(new s_);let l=new sf,u=new Qg,d=new Rg,f=null,p=0;d.load(`./models/banana/source/export_banana.mtl`,e=>{e.preload(),u.setMaterials(e),u.load(`./models/banana/source/export_banana.obj`,e=>{let t=l.load(`./models/banana/textures/Diffuse.png`);e.traverse(e=>{e.isMesh&&(e.material.map=t,e.material.needsUpdate=!0,e.layers.set(0))}),f=e,n.add(e)})});let m=new Ru(new Cd(.5,24,24),new Nd({color:16766720,emissive:16766720,emissiveIntensity:2,depthWrite:!1}));n.add(m);let h=new Sf(16766720,15,0);h.position.set(0,0,0),h.layers.set(0),n.add(new wf(16777215,.05));let g=l.load(`./models/lensflare/textures/lensflare3.png`),_=new $g;_.addElement(new e_(g,30,.7,h.color)),_.addElement(new e_(g,40,.9,h.color)),_.addElement(new e_(g,25,1,h.color)),h.add(_),n.add(h);let{starField:v,lineSegments:y}=(()=>{let e=1e3,t=new fu,r=new Float32Array(e*3);for(let t=0;t<e;t++)r[t*3]=(Math.random()-.5)*100,r[t*3+1]=(Math.random()-.5)*100,r[t*3+2]=(Math.random()-.5)*100;t.setAttribute(`position`,new Zl(r,3));let i=new md(t,new ld({color:16777215,size:.1}));n.add(i);let a=new Float32Array(e*6),o=[`#FF0000`,`#FFA500`,`#FFFF00`,`#00FF00`,`#FFFFFF`,`#0000FF`],s=new Float32Array(e*6);for(let t=0;t<e;t++){let e=r[t*3],n=r[t*3+1],i=r[t*3+2];a[t*6]=e,a[t*6+1]=n,a[t*6+2]=i,a[t*6+3]=e+1,a[t*6+4]=n-.5,a[t*6+5]=i+1;let c=new X(o[Math.floor(Math.random()*o.length)]);s.set([c.r,c.g,c.b,c.r,c.g,c.b],t*6)}let c=new fu;c.setAttribute(`position`,new Zl(a,3)),c.setAttribute(`color`,new Zl(s,3));let l=new cd(c,new Xu({vertexColors:!0}));return n.add(l),{starField:i,lineSegments:l}})(),b=0,x=()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),i.setSize(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight),s.material.uniforms.resolution.value.set(1/(window.innerWidth*c*1.25),1/(window.innerHeight*c*1.25))};window.addEventListener(`resize`,x);let S=()=>{a.update(),o.render(),f&&(b+=.01,f.position.x=m.position.x+3*Math.cos(b),f.position.y=m.position.y+3*Math.sin(b),f.rotation.x+=.01,f.rotation.y+=.014);let e=v.geometry.attributes.position,t=y.geometry.attributes.position;for(let n=0;n<e.count;n++){let r=e.getX(n),i=e.getY(n),a=e.getZ(n);e.setX(n,r<-50?50:r-.1),e.setY(n,i>50?-50:i+.05),e.setZ(n,a<-50?50:a-.1),t.setXYZ(n*2,r,i,a),t.setXYZ(n*2+1,r+5,i-2.5,a+5)}e.needsUpdate=!0,t.needsUpdate=!0};return i.setAnimationLoop?i.setAnimationLoop(S):p=requestAnimationFrame(S),()=>{window.removeEventListener(`resize`,x),i.setAnimationLoop?i.setAnimationLoop(null):cancelAnimationFrame(p),a.dispose(),o.dispose(),i.dispose(),e.removeChild(i.domElement)}},[]),(0,V.jsx)(`div`,{ref:t,className:`space-background`,style:{opacity:e},"aria-hidden":`true`})}function p_({title:e,titleId:t,...n},r){return _.createElement(`svg`,Object.assign({xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`currentColor`,"aria-hidden":`true`,"data-slot":`icon`,ref:r,"aria-labelledby":t},n),e?_.createElement(`title`,{id:t},e):null,_.createElement(`path`,{fillRule:`evenodd`,d:`M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69.75.75 0 0 1 .981.98 10.503 10.503 0 0 1-9.694 6.46c-5.799 0-10.5-4.7-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 0 1 .818.162Z`,clipRule:`evenodd`}))}var m_=_.forwardRef(p_);function h_({title:e,titleId:t,...n},r){return _.createElement(`svg`,Object.assign({xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`currentColor`,"aria-hidden":`true`,"data-slot":`icon`,ref:r,"aria-labelledby":t},n),e?_.createElement(`title`,{id:t},e):null,_.createElement(`path`,{d:`M12 2.25a.75.75 0 0 1 .75.75v2.25a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75ZM7.5 12a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM18.894 6.166a.75.75 0 0 0-1.06-1.06l-1.591 1.59a.75.75 0 1 0 1.06 1.061l1.591-1.59ZM21.75 12a.75.75 0 0 1-.75.75h-2.25a.75.75 0 0 1 0-1.5H21a.75.75 0 0 1 .75.75ZM17.834 18.894a.75.75 0 0 0 1.06-1.06l-1.59-1.591a.75.75 0 1 0-1.061 1.06l1.59 1.591ZM12 18a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-2.25A.75.75 0 0 1 12 18ZM7.758 17.303a.75.75 0 0 0-1.061-1.06l-1.591 1.59a.75.75 0 0 0 1.06 1.061l1.591-1.59ZM6 12a.75.75 0 0 1-.75.75H3a.75.75 0 0 1 0-1.5h2.25A.75.75 0 0 1 6 12ZM6.697 7.757a.75.75 0 0 0 1.06-1.06l-1.59-1.591a.75.75 0 0 0-1.061 1.06l1.59 1.591Z`}))}var g_=_.forwardRef(h_);function __(){let[e,t]=(0,_.useState)(!1);return(0,_.useEffect)(()=>(document.documentElement.dataset.theme=e?`night`:`day`,()=>{delete document.documentElement.dataset.theme}),[e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(f_,{opacity:e?1:.5}),(0,V.jsxs)(`div`,{className:`page-shell`,children:[(0,V.jsx)(`button`,{type:`button`,className:`theme-toggle ${e?`theme-toggle--night`:`theme-toggle--day`}`,onClick:()=>t(e=>!e),"aria-pressed":e,"aria-label":e?`Switch to day mode`:`Switch to night mode`,children:e?(0,V.jsx)(V.Fragment,{children:(0,V.jsx)(m_,{className:`theme-toggle__icon`,"aria-hidden":`true`})}):(0,V.jsx)(V.Fragment,{children:(0,V.jsx)(g_,{className:`theme-toggle__icon`,"aria-hidden":`true`})})}),(0,V.jsxs)(`section`,{id:`center`,children:[(0,V.jsx)(`div`,{className:`hero text-4xl font-bold`,children:`phuc nguyen`}),(0,V.jsx)(`div`,{className:`hero`,children:`software dev`})]}),(0,V.jsx)(`div`,{className:`ticks`}),(0,V.jsxs)(`section`,{id:`next-steps`,children:[(0,V.jsxs)(`div`,{id:`docs`,children:[(0,V.jsx)(`svg`,{className:`icon`,role:`presentation`,"aria-hidden":`true`,children:(0,V.jsx)(`use`,{href:`/icons.svg#documentation-icon`})}),(0,V.jsx)(`h2`,{children:`projects`}),(0,V.jsx)(`p`,{children:`stuffs i have worked on`}),(0,V.jsx)(`ul`,{className:`flex flex-col`,children:y.map((e,t)=>(0,V.jsx)($a,{...e},t))}),(0,V.jsx)(`div`,{children:` You've reached the end!`}),(0,V.jsxs)(`div`,{children:[` i've got more projects on my `,(0,V.jsx)(`a`,{href:`https://github.com/PhucNguyenLamp`,target:`_blank`,className:`underline`,children:`github`}),`, but i thought they would be irrelevant to show you here`]})]}),(0,V.jsxs)(`div`,{id:`social`,children:[(0,V.jsx)(`svg`,{className:`icon`,role:`presentation`,"aria-hidden":`true`,children:(0,V.jsx)(`use`,{href:`/icons.svg#social-icon`})}),(0,V.jsx)(`h2`,{children:`connect`}),(0,V.jsx)(`p`,{children:`my social profiles`}),(0,V.jsx)(`a`,{href:`mailto:phuc.nguyengia@hcmut.edu.vn`,className:`underline`,children:`phuc.nguyengia@hcmut.edu.vn`}),(0,V.jsx)(`br`,{}),(0,V.jsx)(`a`,{href:`mailto:giaphuc29082004@gmail.com`,className:`underline`,children:`giaphuc29082004@gmail.com`}),(0,V.jsxs)(`ul`,{children:[(0,V.jsx)(`li`,{children:(0,V.jsxs)(`a`,{href:`https://github.com/PhucNguyenLamp`,target:`_blank`,children:[(0,V.jsx)(`svg`,{className:`button-icon`,role:`presentation`,"aria-hidden":`true`,children:(0,V.jsx)(`use`,{href:`/icons.svg#github-icon`})}),`GitHub`]})}),(0,V.jsx)(`li`,{children:(0,V.jsxs)(`a`,{href:`https://discord.com/users/345935986217320449`,target:`_blank`,children:[(0,V.jsx)(`svg`,{className:`button-icon`,role:`presentation`,"aria-hidden":`true`,children:(0,V.jsx)(`use`,{href:`/icons.svg#discord-icon`})}),`Discord`]})})]})]})]}),(0,V.jsx)(`div`,{className:`ticks`}),(0,V.jsx)(`section`,{id:`spacer`}),(0,V.jsx)(Xa,{})]})]})}var v_=_i([{path:`/`,element:(0,V.jsx)(__,{})}]),y_=c(m(),1);function b_(e){return _.createElement(Or,{flushSync:y_.flushSync,...e})}(0,v.createRoot)(document.getElementById(`root`)).render((0,V.jsx)(_.StrictMode,{children:(0,V.jsx)(b_,{router:v_,children:(0,V.jsx)(__,{})})}));